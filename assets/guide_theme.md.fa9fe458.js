import{_ as l,r as e,o as p,c as o,b as n,d as s}from"./app.d991dbbc.js";const v=JSON.parse('{"title":"主题","description":"","frontmatter":{},"headers":[{"level":2,"title":"框架主题","slug":"框架主题","link":"#框架主题","children":[{"level":3,"title":"基础版","slug":"基础版","link":"#基础版","children":[]},{"level":3,"title":"专业版","slug":"专业版","link":"#专业版","children":[]}]},{"level":2,"title":"颜色方案","slug":"颜色方案","link":"#颜色方案","children":[]},{"level":2,"title":"导航栏风格","slug":"导航栏风格","link":"#导航栏风格","children":[{"level":3,"title":"填充风格","slug":"填充风格","link":"#填充风格","children":[]},{"level":3,"title":"激活风格","slug":"激活风格","link":"#激活风格","children":[]}]},{"level":2,"title":"面包屑导航风格","slug":"面包屑导航风格","link":"#面包屑导航风格","children":[]},{"level":2,"title":"标签栏风格","slug":"标签栏风格","link":"#标签栏风格","children":[]},{"level":2,"title":"Element Plus 主题","slug":"element-plus-主题","link":"#element-plus-主题","children":[]},{"level":2,"title":"Element Plus 样式","slug":"element-plus-样式","link":"#element-plus-样式","children":[]},{"level":2,"title":"Element Plus 默认尺寸","slug":"element-plus-默认尺寸","link":"#element-plus-默认尺寸","children":[]},{"level":2,"title":"开发注意","slug":"开发注意","link":"#开发注意","children":[]}],"relativePath":"guide/theme.md"}'),t={name:"guide/theme.md"},c=s(`<h1 id="主题" tabindex="-1">主题 <a class="header-anchor" href="#主题" aria-hidden="true">#</a></h1><h2 id="框架主题" tabindex="-1">框架主题 <a class="header-anchor" href="#框架主题" aria-hidden="true">#</a></h2><h3 id="基础版" tabindex="-1">基础版 <a class="header-anchor" href="#基础版" aria-hidden="true">#</a></h3><p>基础版主题样式存放在 <code>/src/assets/styles/themes.scss</code> 文件中，均为 css 变量，修改后即可在页面上查看效果，注意明亮和暗黑模式的区分。</p><h3 id="专业版" tabindex="-1">专业版 <a class="header-anchor" href="#专业版" aria-hidden="true">#</a></h3><p>与基础版不同，专业版默认提供了 6 款主题，并且主题在运行时共存，可实现动态切换。</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line"><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> globalSettings</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Settings</span><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">all</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line highlighted"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">},</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h2 id="颜色方案" tabindex="-1">颜色方案 <a class="header-anchor" href="#颜色方案" aria-hidden="true">#</a></h2><p>在应用配置中设置：</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line"><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> globalSettings</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Settings</span><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">all</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
<span class="line highlighted"><span style="color:#A6ACCD;">  </span><span style="color:#F07178;">app</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
<span class="line highlighted"><span style="color:#A6ACCD;">    </span><span style="color:#676E95;font-style:italic;">/**</span></span>
...
<span class="line highlighted"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">},</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h2 id="导航栏风格" tabindex="-1">导航栏风格 <sup class="pro-badge"></sup> <a class="header-anchor" href="#导航栏风格" aria-hidden="true">#</a></h2><h3 id="填充风格" tabindex="-1">填充风格 <a class="header-anchor" href="#填充风格" aria-hidden="true">#</a></h3><p>在应用配置中设置：</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line"><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> globalSettings</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Settings</span><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">all</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line highlighted"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">},</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div>`,13),i=s(`<h3 id="激活风格" tabindex="-1">激活风格 <a class="header-anchor" href="#激活风格" aria-hidden="true">#</a></h3><p>在应用配置中设置：</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line"><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> globalSettings</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Settings</span><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">all</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
<span class="line highlighted"><span style="color:#A6ACCD;">  </span><span style="color:#F07178;">menu</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
<span class="line highlighted"><span style="color:#A6ACCD;">    </span><span style="color:#676E95;font-style:italic;">/**</span></span>
<span class="line highlighted"><span style="color:#676E95;font-style:italic;">     * 留空默认</span></span>
...
<span class="line highlighted"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">},</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div>`,3),y=s(`<h2 id="面包屑导航风格" tabindex="-1">面包屑导航风格 <sup class="pro-badge"></sup> <a class="header-anchor" href="#面包屑导航风格" aria-hidden="true">#</a></h2><p>在应用配置中设置：</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line"><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> globalSettings</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Settings</span><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">all</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line highlighted"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">},</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div>`,3),D=s(`<h2 id="标签栏风格" tabindex="-1">标签栏风格 <sup class="pro-badge"></sup> <a class="header-anchor" href="#标签栏风格" aria-hidden="true">#</a></h2><p>在应用配置中设置：</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line"><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> globalSettings</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Settings</span><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">all</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">},</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div>`,3),C=s(`<h2 id="element-plus-主题" tabindex="-1">Element Plus 主题 <a class="header-anchor" href="#element-plus-主题" aria-hidden="true">#</a></h2><blockquote><p>详细可阅读 Element Plus 官方文档《<a href="https://element-plus.gitee.io/zh-CN/guide/theming.html" target="_blank" rel="noreferrer">自定义主题</a>》。</p></blockquote><p>你可以在 <code>/src/assets/style/element-plus/index.scss</code> 和 <code>/src/assets/style/element-plus/dark.scss</code> 文件中分别修改 Element Plus 的明亮和暗黑模式下的预设样式。</p><p>你可以到 Element Plus 的 <a href="https://github.com/element-plus/element-plus/blob/dev/packages/theme-chalk/src/common/var.scss" target="_blank" rel="noreferrer"><code>packages/theme-chalk/src/common/var.scss</code></a> 和 <a href="https://github.com/element-plus/element-plus/blob/dev/packages/theme-chalk/src/dark/var.scss" target="_blank" rel="noreferrer"><code>packages/theme-chalk/src/dark/var.scss</code></a> 中查找更多明亮和暗黑模式下的 scss 变量。</p><h2 id="element-plus-样式" tabindex="-1">Element Plus 样式 <a class="header-anchor" href="#element-plus-样式" aria-hidden="true">#</a></h2><p>有时候，我们可能需要重写 Element Plus 组件的一些默认样式，除了可以在 SFC 单文件组件里单独重写外，你也可以在 <code>/src/assets/style/element-plus/override.scss</code> 文件中进行全局重写。</p><h2 id="element-plus-默认尺寸" tabindex="-1">Element Plus 默认尺寸 <a class="header-anchor" href="#element-plus-默认尺寸" aria-hidden="true">#</a></h2><p>在应用配置中设置：</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line"><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> globalSettings</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Settings</span><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">all</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
<span class="line highlighted"><span style="color:#A6ACCD;">  </span><span style="color:#F07178;">app</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
<span class="line highlighted"><span style="color:#A6ACCD;">    </span><span style="color:#676E95;font-style:italic;">/**</span></span>
<span class="line highlighted"><span style="color:#676E95;font-style:italic;">     * default 默认</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><p>最后分享一篇关于暗黑模式的文章《<a href="http://www.woshipm.com/pd/4105894.html" target="_blank" rel="noreferrer">教你巧用UI设计中的暗黑模式——Dark Mode</a>》，希望帮助你更好地在暗黑模式下开发出优秀的页面。</p>`,19);function h(A,F,d,g,u,m){const a=e("ZoomImg");return p(),o("div",null,[c,n(a,{src:"/theme.gif"}),r,n(a,{src:"/menu-fill-style.png"}),i,n(a,{src:"/menu-active-style.png"}),y,n(a,{src:"/breadcrumb-style.png"}),D,n(a,{src:"/tabbar-style.png"}),C])}const _=l(t,[["render",h]]);export{v as __pageData,_ as default};
